...
import {getLabList, saveLab, setLabStatus} from '@/services/laboratory';
...
const handleUpdate = async (data, ref) => {
    ...
    <PageContainer>
      <ProTable
        ...
        request={async (params) => {
          ...
          const res = await getLabList(form)
      ...
      {createModalVisible ? (
        <CreateForm
          onSubmit={async (value) => {
            const success = await handleAdd({...value.area, ...{name: value.name}});
