...
export async function getInspectionItem(data) {
  return request('/api/inspection-item/get', {method: 'post', data});
}


export async function delInspectionItem(data) {
  return request('/api/inspection-item/del', {method: 'post', data});
}
